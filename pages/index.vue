            ...
            <v-card flat>
              <v-card-text>
                ...
                <v-row dense>
                  <v-col cols="12">
                    <div>
                      <div class="text-body-2 font-weight-bold">Número Pelotão</div>
                      <div>{{ item.numero_pelotao || "Não informado" }}</div>
                    </div>
                  </v-col>
                  <v-col cols="12">
                    <div>
                      <div class="text-body-2 font-weight-bold">Militar Responsável</div>
                  ...
                  <v-col cols="12">
                    <div>
                      ...
                      <div> <span>{{ item.aph === 1 ? 'Sim' : 'Não' }}</span></div>
                    </div>
                  </v-col>
                  <v-col cols="12" sm="6">
                    <div>
                      <div class="text-body-2 font-weight-bold">Civis Resgatados</div>
                      <div style="min-height: 15px;">{{ item.quantidade_civis || "Não informado" }}</div>
                    </div>
                  </v-col>
                  <v-col cols="12" sm="6">
                    <div>
                      <div class="text-body-2 font-weight-bold">Quantidade Pets</div>
                      <div style="min-height: 15px;">{{ item.quantidade_pets || "Não informado"}}</div>
                    </div>
                  </v-col>
                  <v-col cols="12">
                    <div>
                      <div class="text-body-2 font-weight-bold">Meios de Acesso</div>
                      <div>
                  ...
                  <v-col cols="12">
                    <div>
                      <div class="text-body-2 font-weight-bold">Coordenadas</div>
                      <div>
              ...
              <v-card-actions class="d-flex flex-row justify-between" style="gap: 5px">
                <v-btn
                  text="Editar"
                  color="primary"
                  variant="flat"
      ...
      <v-card>
        ...
        <v-card-text style="height: 500px">
          ...
          <v-form ref="form" v-model="form_valid" lazy-validation>
            <v-row dense>
              <v-col cols="12" sm="12">
                <v-text-field label="Número do Pelotão" v-model="payloadForm.numero_pelotao" :rules="[rules.required]"></v-text-field>
              </v-col>

              <v-col cols="12" sm="12">
                <v-text-field label="Nome do Militar Responsável" v-model="payloadForm.nome_militar_resp" :rules="[rules.required]"></v-text-field>
              </v-col>
              ...
              <v-col cols="12" sm="12">
                <v-text-field label="Endereço" v-model="payloadForm.endereco" :rules="[rules.required]"></v-text-field>
              </v-col>

              <v-col cols="12" sm="12" md="6">
                <v-text-field label="Lagitude (Leitura)" v-model="payloadForm.latitude" readonly></v-text-field>
              </v-col>

              <v-col cols="12" sm="12" md="6">
                <v-text-field label="Longitude (Leitura)" v-model="payloadForm.longitude" readonly></v-text-field>
              </v-col>
