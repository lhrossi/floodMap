...
<template>
  <div class="w-full relative">
    ...
    <ul
      v-if="open"
      ref="list"
      class="w-full absolute mobile:bottom-10 laptop:bottom-12 left-0 bg-neutral-100 shadow rounded-3xl overflow-y-auto mobile:max-h-[310px] laptop:max-h-[430px] pt-2"
      :class="{
