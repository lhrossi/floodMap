...
<template>
  <div class="text">
    <h3>Aprenda como utilizar o mapa</h3>

    <v-container class="steps mb-5">
      <div class="step">
        <div>
          ...
          <div class="content pr-8">
            <p>
              Procure pelo abrigo que deseja informações de como ajudar na sua região ou filtre os abrigos que mais
              precisam do tipo de doação que você quer fazer
            </p>
          </div>
      ...
      <div class="flex flex-col sm:mt-4 lg:mt-8 lg:mr-2 p-4 rounded-lg border-2 bg-white">
        <svg
          class="block size-6 mb-2"
          width="24"
          height="24"
          viewBox="0 0 24 24"
          fill="none"
        ...
        <h4 class="text-sm font-semibold mb-1">
          Não faça sua doação sem antes conferir com o abrigo!
        </h4>

        <p class="text-xs font-normal">
          O dia a dia é muito dinâmico e a lista corre o risco de estar desatualizada!
        </p>
      </div>
    </v-container>
  </div>
