...
<template>
  <div class="card-container">
    <div class="card-header">
      ...
      <ShelterAvatar :occupation-utils="occupationUtils" />
    </div>
    ...
    <div class="card-content">
      ...
      <div
        v-if="!!needsList.length || isCityCentralizedDonations"
        class="card-needs__wrapper"
      >
        <h3>Necessidades</h3>
    ...
    <div class="card-footer">
      ...
      <button
        v-if="!!shelter.telefone"
        class="card-footer__button whatsapp-button"
        @click="linkToWhatsapp"
      >
        Whatsapp
      </button>
    </div>
